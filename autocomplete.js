...
// export possible genders as array
export const gender = [
  "Male",
  "Female",
  "Transgender",
];
export const partnerGender = gender;
...
export const partnerMaritalStatus = [
  "Married",
  "Widowed",
  "Seperated",
  "Divorced",
